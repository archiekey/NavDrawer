...
import fragment.SavedHousesFragment;
...
public class MainActivityNavDrawer extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_gallery) {
            Intent i = new Intent(MainActivityNavDrawer.this, MapsActivity.class);
            startActivity(i);
            //container id in content_main, new frag class instance, commit
        }
        else if (id == R.id.nav_manage) {
            fm.beginTransaction().replace(R.id.content_frame, new SavedHousesFragment()).commit();
